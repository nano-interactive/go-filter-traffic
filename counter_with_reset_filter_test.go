...
func TestFilterTraffic_SkipEverything_GlobalTraffic_Is_Zero(t *testing.T) {
	...
	r := NewCounterFilter(PercentageFilterConfig{Enabled: true}, globalFilter, perValueFilter)
...
func BenchmarkRepository_FilterTraffic_Disabled(b *testing.B) {
	...
	r := NewCounterFilter(PercentageFilterConfig{Enabled: false}, globalFilter, perValueFilter)
